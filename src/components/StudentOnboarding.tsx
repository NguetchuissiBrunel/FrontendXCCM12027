...
const StudentOnboarding = () => {
    ...
    const waitTimeoutRef = useRef<NodeJS.Timeout>();
    ...
    const isStudentDashboardPage = useCallback(() => {
        ...
        return studentRoutes.some(route => {
            if (route === '/etudashboard') {
                return pathname === '/etudashboard' || pathname === '/etudashboard/';
            }
    ...
    const getStepsForCurrentPage = useCallback(() => {
        if (pathname === '/etudashboard' || pathname === '/etudashboard/') {
            return HOME_PAGE_STEPS;
        } else if (pathname === '/etudashboard/cours') {
            return COURSES_PAGE_STEPS;
        } else if (pathname === '/etudashboard/exercises') {
            return EXERCISES_PAGE_STEPS;
        } else if (pathname === '/etudashboard/submissions') {
            return SUBMISSIONS_PAGE_STEPS;
        } else if (pathname === '/etudashboard/echeances') {
            return DEADLINES_PAGE_STEPS;
        } else if (pathname === '/etudashboard/profil') {
