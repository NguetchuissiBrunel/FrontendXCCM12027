          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
               ...
               <div 
                 ...
                 className={`relative border-2 border-dashed rounded-2xl transition-all h-40 flex flex-col items-center justify-center overflow-hidden cursor-pointer ${
                   imagePreview ? 'border-purple-400' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 hover:border-purple-400 hover:bg-purple-50/30'
                 }`}
               >
            ...
            <div className="space-y-3">
               ...
               <div 
                 ...
                 className={`relative border-2 border-dashed rounded-2xl transition-all h-40 flex flex-col items-center justify-center cursor-pointer ${
                   fileData ? 'border-purple-400 bg-purple-50/30' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 hover:border-purple-400'
                 }`}
               >
