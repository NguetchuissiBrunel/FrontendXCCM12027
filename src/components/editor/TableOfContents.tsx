...
export const TableOfContents: React.FC<TableOfContentsProps> = ({ 
        ...
        >
          ...
          {hasChildren ? (
            <button
              ...
              className="mr-1.5 flex h-5 w-5 shrink-0 items-center justify-center text-gray-400 hover:text-gray-600"
            >
              {isExpanded ? (
          ...
          {/* File icon */}
          <FaFile className="mr-2 shrink-0 text-xs text-gray-400" />
          ...
          <span
            ...
            style={{ color: isActive ? '#7c3aed' : color }}
          >
            {item.title}
          </span>
        </div>
  ...
  return (
    <div className="h-full overflow-y-auto bg-white">
      <div className="py-3">
        <h2 className="mb-3 px-3 text-sm font-semibold text-gray-700">
          Table des Matières
        </h2>
        {items.length > 0 ? (
