...
// Icônes (simulées avec des SVGs, comme dans la Navbar)
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-4 xl:gap-8">
          ...
          <div className="space-y-6 xl:col-span-1 border-r border-gray-700 pr-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 sm:mt-0 sm:grid-cols-3 xl:col-span-2 pl-8">
            
            <div>
              <h3 className="text-sm font-semibold text-purple-400 tracking-wider uppercase">Services</h3>
              <ul className="mt-4 space-y-4">
                <li><Link href="/courses" className="text-base text-gray-400 hover:text-white transition-colors">Création de Cours</Link></li>
                <li><Link href="/collaboration" className="text-base text-gray-400 hover:text-white transition-colors">Espaces Collaboratifs</Link></li>
                <li><Link href="/library" className="text-base text-gray-400 hover:text-white transition-colors">Bibliothèque de Contenu</Link></li>
                <li><Link href="/pricing" className="text-base text-gray-400 hover:text-white transition-colors">Tarification</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link href="/about" className="text-base text-gray-400 hover:text-white transition-colors">À Propos</Link></li>
                <li><Link href="/jobs" className="text-base text-gray-400 hover:text-white transition-colors">Carrières (Jobs)</Link></li>
                <li><Link href="/press" className="text-base text-gray-400 hover:text-white transition-colors">Presse</Link></li>
                <li><Link href="/partners" className="text-base text-gray-400 hover:text-white transition-colors">Partenaires</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link href="/help" className="text-base text-gray-400 hover:text-white transition-colors">Centre d'Aide</Link></li>
                <li><Link href="/faq" className="text-base text-gray-400 hover:text-white transition-colors">FAQ</Link></li>
                <li><Link href="/blog" className="text-base text-gray-400 hover:text-white transition-colors">Blog & Guides</Link></li>
                <li><Link href="/support" className="text-base text-gray-400 hover:text-white transition-colors">Support Technique</Link></li>
              </ul>
            </div>
          </div>

          {/* Section 4: Newsletter (MODIFIÉE) */}
          <div className="mt-12 xl:mt-0 xl:col-span-1 pl-8 border-l border-gray-700">
            ...
            <form className="flex flex-col space-y-4"> 
              <input
                ...
                className="w-full min-w-0 appearance-none rounded-lg border border-transparent bg-gray-700 py-3 px-4 text-base text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-colors shadow-inner"
              />
              <button
                type="submit"
                className="w-full bg-purple-600 text-white py-3 px-6 rounded-lg hover:bg-purple-700 transition-colors font-medium shadow-md"
              >
                S'abonner
              </button>
            </form>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            {/* Social Icons */}
            <div className="flex space-x-6 order-2 md:order-1 mt-6 md:mt-0">
            ...
            {/* Legal Links */}
            <div className="flex space-x-6 order-3 md:order-2 text-sm">
            ...
            {/* Copyright */}
            <p className="text-sm text-gray-400 order-1 md:order-3">
